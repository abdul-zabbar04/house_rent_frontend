const addPost= (event)=>{
 ...
 let imageUrl = '';
    ...
    if(token){
        ...
        post_error.style.display= 'block'
    }
      ...
      if(data.length===0){
        ...
        data.forEach(element => {
            ...
            `
                ...
                <img src=${element.image}  class="card-img-top" alt="..." style="width: 300px; height: 200px; >
                <div class="card-body">
...
const postDetail= ()=>{
    ...
    .then(element=>{
        ...
        `
        <img src="${element.image} " alt="" class="img-fluid rounded details-img">
